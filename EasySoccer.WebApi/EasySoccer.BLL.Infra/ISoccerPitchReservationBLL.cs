...
namespace EasySoccer.BLL.Infra
{
    public interface ISoccerPitchReservationBLL
    {
        ...
        Task<SoccerPitchReservation> CreateAsync(long soccerPitchId, Guid? personId, DateTime selectedDate, TimeSpan hourStart, TimeSpan hourFinish, string note, long soccerPitchPlanId);
