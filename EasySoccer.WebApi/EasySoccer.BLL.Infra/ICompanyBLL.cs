...
namespace EasySoccer.BLL.Infra
{
    ...
    {
        Task<List<CompanyModel>> GetAsync(double? longitude, double? latitude, int page, int pageSize, string name, string orderField, string orderDirection, int idCity, int idState);
        ...
        Task StartConversationAsync(string json);
